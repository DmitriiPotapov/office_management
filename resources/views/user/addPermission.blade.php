    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Define new permission</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-body">
                    ...
                    @csrf
                        <div class="form-body">
                            <h3 class="card-title">Define new permission</h3>
                            <div class="row p-t-20">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label">Permission Name</label>
                                        <input type="text" id="permission_name" name="permission_name" class="form-control" placeholder="Enter permission name" required>
