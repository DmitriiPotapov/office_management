...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Job priority</h3>
            <a href = "{{URL::to('settings/lists/jobpriorities/create')}}"><button type="button" class="btn btn-info"><i class="ti-plus text" aria-hidden="true"></i> New job priority</button></a>
        </div>
