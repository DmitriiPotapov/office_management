        ...
        <div class="col-sm-12 col-xs-12">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="client_name" id="client_name" value="{{ $quote->client_name }}" />
                    <input type="hidden" class="form-control" name="job_status" id="job_status" value="{{ $quote->status }}" />
                                ...
                                <div class="table-responsive">
                                    <table id="invoice_item_mainTable" class="table editable-table table-bordered table-striped m-b-0">
                                        ...
                                        <tbody id="invoie_items_table">
                                            ...
                                            <td id="item_total_price">{{ $quote->item_total_price }}</td>
                                            </tr>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="quote_id" value="{{ $quote->quote_id }}" id="quote_id" />
                                <div class="form-group">
                            ...
                            <div class="modal-body">                                                                                  
                                  <div class="card">
                                      <div class="card-body">   
                                          ...
                                          <input class="typeahead form-control" type="text" placeholder="JobID" id="quote_job_id" name="quote_job_id" class="typeahead form-control" value="{{ $quote->job_id }}">
                                          </div>
                                      </div>
                                  </div>                                                               
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#jobPost').on('click', function (e) {
            ...
            e.preventDefault(e);
            var update_quote_id = $("#update_quote_id").val();
            ...
            $.ajax({
                url: '/quote/updateAction',
                type: 'POST',
                dataType: 'json',
                data: {
                    update_quote_id: update_quote_id,
                    quote_id: quote_id,
        ...
        $("#generateView").on('click', function (e) {
            ...
            {
                console.log(job_id);
                var link = "http://localhost:8000/job/generateQuoteViewTemplate/"+job_id+"/"+item_price+"/"+item_discount+"/"+item_total_price+"/"+item_brand.toString()+"/"+item_serial;
                console.log(link);
                location.href = link;
            }
        });
