        ...
        <div class="input-group" style = "margin: 0px; padding: 0px;">
          ...
          <div id="adult">
            <div class="col-md-4" style="margin: 0px;padding: 0px;">
                <div class="input-group" style="margin-left: 0px;margin-bottom:10px; padding: 0px;">
                  <div class="input-group-prepend">
...
<script>
  ...
  function onSerialAdd()
  {
    ...
    divtest.setAttribute("style", "margin: 0px;padding: 0px;");
    divtest.setAttribute("class", "col-md-4 removeclass" + room);
    divtest.innerHTML = '<div class="input-group" style="margin-left:0px;margin-bottom:10px;padding:0px;"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1">Serial Number'+room+'</span></div><input type="text" class="form-control" id="serial" name="serial'+room+'"></div>';
