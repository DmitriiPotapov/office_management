                ...
                <div class = "row">
                    <div class = "col-md-3" style = "margin: 0px; ">
                      <div class="input-group">    
                          ...
                          <input type="text" class="form-control" aria-describedby="basic-addon1" name = "client_name" required>  
                      </div>
                    </div>
                    <div class = "col-md-3" style = "margin: 0px; padding-left: 30px;">
                        <div class="input-group" style="margin: 0px; padding: 0px;">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">Client Email</span>
                            </div>
                            <input type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" name = "email_value" required>  
                        </div>
                    </div>
                    <div class = "col-md-3" style = "margin: 0px; padding-left: 30px;">
                        <div class="input-group" style="margin: 0px; padding: 0px;">
